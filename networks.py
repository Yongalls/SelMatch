...
def VGG16BN(channel, num_classes):
    return VGG('VGG16', channel, num_classes, norm='batchnorm')
...
def ResNet34BN(channel, num_classes):
...
def ResNet50BN(channel, num_classes):
...
def ResNet101BN(channel, num_classes):
